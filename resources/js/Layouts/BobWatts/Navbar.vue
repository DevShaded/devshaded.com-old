            ...
            <div class="flex items-center justify-between h-16">
                <div class="flex items-center">
                    <div class="flex-shrink-0">
                        <a href="/bobwatts">
                            <img class="block lg:hidden h-12 w-auto" src="/images/BobWattsLogoRounded.png" alt="Bob Watts"/>
                        </a>

                        <a href="/bobwatts">
                            <img class="hidden lg:block h-12 w-auto" src="/images/BobWattsLogoRounded.png" alt="Bob Watts"/>
                        </a>
                    </div>
